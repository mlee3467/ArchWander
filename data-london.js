...
,
  ...
  /* ── GRIMSHAW ARCHITECTS ─────────────────────────────────── */
  {
    id: 'waterloo-international-terminal',
    name: 'Waterloo International Terminal',
    cat: 'Infrastructure', cc: 'c-inf', styleGroup: 'High-Tech',
    era: '1970–1999', city: 'london',
    arch: 'Grimshaw Architects', archs: ['Grimshaw Architects'],
    yr: 1994, access: 'Open to Public', style: 'High-Tech',
    lat: 51.5031, lng: -0.1132,
    addr: 'Waterloo Station, London SE1 8SW', hood: 'Waterloo / South Bank',
    desc: 'The Waterloo International Terminal is widely regarded as one of the finest examples of High-Tech architecture in Britain. Designed by Nicholas Grimshaw & Partners as the London terminus for Eurostar services via the Channel Tunnel, the building wraps around the western edge of Waterloo Station with a sinuous 400-metre asymmetric glazed roof composed of 36 bow-string trusses. The varying curvature of each bay responds to the tight site geometry while creating a flowing, luminous canopy above five international platforms. Completed within its £130m budget, it won the RIBA President\'s Building of the Year and the Mies van der Rohe Pavilion Award in 1994. Eurostar services relocated to St Pancras in 2007; the terminal now serves domestic Southwestern Railway trains.',
    hours: 'Open daily (active station)',
    lastEntry: '',
    admission: 'Free (station access)',
    tourOk: false,
    tourInfo: 'No guided tours. Terminal roof visible from platforms 20–24.',
    web: 'https://www.networkrail.co.uk/running-the-railway/our-stations/waterloo/',
    transit: 'Jubilee · Bakerloo · Northern · Waterloo & City → Waterloo',
    walkFrom: 'South Bank / Tate Modern: 10 min · Houses of Parliament: 12 min',
    gmaps: 'https://maps.google.com/?q=Waterloo+International+Terminal+London',
    archdaily: 'https://www.archdaily.com/tag/waterloo-international-terminal',
    wiki: 'https://en.wikipedia.org/wiki/Waterloo_International_railway_station',
    tags: ['Grimshaw Architects', 'High-Tech', 'Eurostar', 'Train Station', 'Glazed Roof', 'Nicholas Grimshaw', 'RIBA Award', 'Mies van der Rohe Prize'],
    photos: [],
    drawings: []
  },
  {
    id: 'financial-times-printworks',
    name: 'Financial Times Printworks',
    cat: 'Historic', cc: 'c-his', styleGroup: 'High-Tech',
    era: '1970–1999', city: 'london',
    arch: 'Grimshaw Architects', archs: ['Grimshaw Architects'],
    yr: 1988, access: 'Limited (Events Only)', style: 'High-Tech',
    lat: 51.4777, lng: -0.0525,
    addr: '18 Surrey Canal Rd, London SE14 5RS', hood: 'Surrey Quays / Deptford',
    desc: 'The Financial Times Printworks is a seminal work of British High-Tech architecture by Nicholas Grimshaw & Partners, designed to house the high-speed rotary presses of the Financial Times newspaper. The building is celebrated for its dramatic exposed steel portal frame structure clad with flush aluminium panels and vast glass walls that placed the industrial machinery on full display from the street — celebrating production process as spectacle. Officially opened by Prime Minister Margaret Thatcher in 1988, the building is now Grade II listed. It was later converted and rebranded as Printworks London, one of the UK\'s most distinctive large-scale event and music venues, retaining the raw industrial aesthetic of the original Grimshaw design.',
    hours: 'Varies (event venue — check schedule)',
    lastEntry: '',
    admission: 'Ticketed (events only)',
    tourOk: false,
    tourInfo: 'No public tours. Exterior freely viewable from Surrey Canal Road.',
    web: 'https://printworkslondon.co.uk/',
    transit: 'Overground → Surrey Quays · 5 min walk',
    walkFrom: 'Canada Water: 10 min · Deptford: 10 min',
    gmaps: 'https://maps.google.com/?q=Printworks+London+Surrey+Canal+Road',
    archdaily: 'https://www.archdaily.com/tag/financial-times-printworks',
    wiki: 'https://en.wikipedia.org/wiki/Printworks_London',
    tags: ['Grimshaw Architects', 'High-Tech', 'Industrial', 'Listed Building', 'Docklands', 'Nicholas Grimshaw', 'Adaptive Reuse', 'Event Venue', 'Grade II'],
    photos: [],
    drawings: []
  },
  {
    ...
    lat: 51.5052, lng: -0.0864,
    addr: 'Tooley Street, London SE1 2TF', hood: 'London Bridge / Borough',
    desc: 'The reconstruction of London Bridge Station, completed in 2018 after a decade of phased works, is one of Grimshaw\'s most ambitious infrastructure projects. One of London\'s oldest and busiest stations — handling over 90 million passengers annually — was fundamentally reorganised around a vast, naturally lit street-level concourse larger than Wembley\'s football pitch. Nine new through-platforms improved cross-city capacity, while the signature architectural gesture is a series of undulating "eyebrow" voids cut into the platform deck, channelling shafts of daylight into the concourse below. Timber-lined soffits warm the industrial scale of the structure. The design carefully layers 175 years of railway history with precise new interventions, and was shortlisted for the RIBA Stirling Prize.',
    hours: 'Open daily (active station)',
    lastEntry: '',
    admission: 'Free (station access)',
    tourOk: false,
    tourInfo: 'No guided tours. Concourse and architecture freely viewable.',
    web: 'https://www.networkrail.co.uk/running-the-railway/our-stations/london-bridge/',
    transit: 'Jubilee · Northern → London Bridge',
    walkFrom: 'Borough Market: 3 min · The Shard: 3 min · Tate Modern: 12 min',
    gmaps: 'https://maps.google.com/?q=London+Bridge+Station',
    archdaily: 'https://www.archdaily.com/tag/london-bridge-station',
    wiki: 'https://en.wikipedia.org/wiki/London_Bridge_station',
    tags: ['Grimshaw Architects', 'Rail Infrastructure', 'Station', 'Stirling Prize Shortlist', 'Natural Light', 'Concourse', 'Timber', 'Network Rail'],
    photos: [],
    drawings: []
  },
  {
    ...
    lat: 51.5075, lng: 0.0260,
    addr: 'One Western Gateway, Royal Victoria Dock, London E16 1XL', hood: 'Royal Docks / Custom House',
    desc: 'ExCeL London is an international exhibition and convention centre on the northern quay of Royal Victoria Dock in east London. Grimshaw designed Phase II (2010), extending the building by 32,500 sq m to create a total floorplate of over 100,000 sq m — making it one of Europe\'s largest event venues. The defining architectural gesture of the Grimshaw extension is a vibrant yellow spiral at the eastern entrance, rising the full height of the building, that acts as a navigational landmark visible from the DLR. The column-free exhibition halls, triple-height atrium, and 40-metre-wide central boulevard are engineered for maximum flexibility. The venue hosted multiple sports during the 2012 London Olympics and regularly accommodates up to 50,000 visitors.',
    hours: 'Mon–Fri 8am–6pm (office) · Varies by event',
    lastEntry: '',
    admission: 'Free public areas · Ticketed for events',
    tourOk: false,
    tourInfo: 'Public access to concourses and dockside promenade. Event-specific ticketing applies.',
    web: 'https://www.excel.london/',
    transit: 'DLR → Custom House (for ExCeL)',
    walkFrom: 'Canary Wharf (DLR): 5 min · Royal Albert Dock: 5 min',
    gmaps: 'https://maps.google.com/?q=ExCeL+London+Royal+Victoria+Dock',
    archdaily: 'https://www.archdaily.com/tag/excel-london',
    wiki: 'https://en.wikipedia.org/wiki/ExCeL_London',
    tags: ['Grimshaw Architects', 'Exhibition Centre', 'Royal Docks', 'Convention', 'Olympics 2012', 'DLR', 'East London'],
    photos: [],
    drawings: []
  },
  {
    id: 'elizabeth-line',
    name: 'Elizabeth Line — Line-Wide Design',
    cat: 'Infrastructure', cc: 'c-inf', styleGroup: 'Contemporary',
    era: '2000–Present', city: 'london',
    arch: 'Grimshaw Architects', archs: ['Grimshaw Architects', 'Maynard', 'AtkinsRéalis', 'Equation'],
    yr: 2022, access: 'Open to Public', style: 'Contemporary',
    lat: 51.5154, lng: -0.1755,
    addr: 'Paddington Station, London W2 1HQ (representative)', hood: 'Citywide — 10 new stations',
    desc: 'The Elizabeth line, opened in full in November 2022, is London\'s newest and most transformative piece of rail infrastructure — a 62-mile cross-city railway with 26 miles of new tunnels, 10 new stations and 31 upgraded ones, now carrying 700,000 passengers daily. Grimshaw, with Maynard, AtkinsRéalis and Equation, was responsible for the line-wide design: a consistent architectural language of curved glass-reinforced concrete cladding, integrated lighting, bespoke signage totems, platform edge screens and furniture that unifies all 41 stations while allowing each to express its own character above ground. The palette is restrained and tactile — dark ribbed GRC panels, warm lighting from within wayfinding totems, and spacious double-height platforms that are a world apart from older Tube infrastructure. In October 2024, the Elizabeth line won the RIBA Stirling Prize — the most prestigious architecture award in the UK — with the jury calling it "a triumph in architect-led collaboration."',
    hours: 'Mon–Sat approx 6am–1am · Sun 8am–11pm',
    lastEntry: '',
    admission: 'Standard TfL fare',
    tourOk: false,
    tourInfo: 'No dedicated tours. All stations freely accessible with TfL ticket.',
    web: 'https://tfl.gov.uk/modes/elizabeth-line/',
    transit: 'Elizabeth line — Paddington · Bond Street · Tottenham Court Road · Farringdon · Liverpool Street · Canary Wharf · Stratford',
    walkFrom: 'Paddington mainline: 2 min · Hyde Park: 5 min',
    gmaps: 'https://maps.google.com/?q=Elizabeth+Line+Paddington+Station+London',
    archdaily: 'https://www.archdaily.com/1022435/riba-awards-the-2024-stirling-prize-to-the-elizabeth-line',
    wiki: 'https://en.wikipedia.org/wiki/Elizabeth_line',
    tags: ['Grimshaw Architects', 'Elizabeth Line', 'Crossrail', 'Stirling Prize 2024', 'Rail Infrastructure', 'TfL', 'Line-Wide Design', 'RIBA Award'],
    photos: [],
    drawings: []
  }
];
